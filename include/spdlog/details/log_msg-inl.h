...
SPDLOG_INLINE log_msg::log_msg(
    ...
    : log_msg(os::now(), loc, os::pinfo(), a_logger_name, lvl, msg, nullptr, 0)
{}

SPDLOG_INLINE log_msg::log_msg(spdlog::process_info pinfo, string_view_t a_logger_name, spdlog::level::level_enum lvl, 
    spdlog::string_view_t msg, const Field * fields, size_t field_count)
    : log_msg(os::now(), source_loc{}, pinfo, a_logger_name, lvl, msg, fields, field_count)
{}

SPDLOG_INLINE log_msg::log_msg(string_view_t a_logger_name, spdlog::level::level_enum lvl, spdlog::string_view_t msg)
    : log_msg(os::now(), source_loc{}, os::pinfo(), a_logger_name, lvl, msg, nullptr, 0)
{}
